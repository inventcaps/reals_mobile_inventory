...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-(au!8znc(9t!+up-=!qu$*c8rqsfzk_qdbn&yek_ao^_3tfrek')
...
ROOT_URLCONF = 'mobile_inventory.urls'
...
# Suppress staticfiles warnings in production
import warnings
